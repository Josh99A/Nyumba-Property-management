...
const MESSAGE_KEYS: Record<DomainErrorCode, string> = {
  ...
  SEAT_LIMIT_REACHED: 'subscription.seatLimitReached',
  CUSTOM_ROLES_UNAVAILABLE: 'subscription.customRolesUnavailable',
...
const HTTPS_CODES: Record<DomainErrorCode, FunctionsErrorCode> = {
  ...
  SEAT_LIMIT_REACHED: 'resource-exhausted',
  CUSTOM_ROLES_UNAVAILABLE: 'failed-precondition',
