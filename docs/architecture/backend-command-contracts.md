...
| Listing | `listing.saveDraft/publish/unpublish` | owner or authorized workspace staff, or audited Admin/Super Admin acting for the canonical landlord; drafts accept at most five validated staged image paths in cover-first order; publication rechecks approval, availability, advertising entitlement, and moderation |
